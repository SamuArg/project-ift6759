...
def build_loaders(dataset: str, pipeline_type: str, fraction: float,
                  batch_size: int, sigma: int, type_label: str, max_distance: int):
    ...
    train_pipe = SeisBenchPipelineWrapper(split="train", dataset_fraction=fraction, **common)
    ...
    test_loader  = test_pipe.get_dataloader( batch_size=batch_size, num_workers=4, shuffle=False)
