...
for i, size in enumerate(input_sizes):
    ...
    for metric in stead_model:
        ...
        rows.append({
            ...
            "type": "Baseline",
            "metric": metric,
            "value": instance_baseline[metric]
        })
...
g.set_axis_labels("Input Size", "Metric Value")
g.set_titles("{col_name}")
g.set(ylim=(-0.1,1))

g.fig.suptitle("Model vs Baseline Performance", y=1.02)
